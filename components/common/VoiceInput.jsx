...
export const VoiceInput = React.forwardRef(
  (
    ...
    const {
      ...
      stopListening,
      resetTranscript,
      // ⭐ setTranscript এখানে যোগ করুন
      setTranscript, 
      browserSupportsSpeechRecognition,
    } = useVoiceTyping({ continuous: false, interimResults: false, lang: 'en-US' });
    ...
    const handleMicClick = () => {
      if (isListening) {
        ...
        // ⭐ এখানে setTranscript ব্যবহার করা হয়েছে
    ...
    const handleClearClick = () => {
      if (onChange) {
        ...
        // ⭐ এখানে resetTranscript ব্যবহার করা হয়েছে
        resetTranscript(); 
      }
    };
      ...
      return (
        <div className="flex items-center space-x-2">
          <InputComponent
            ...
            {...props}
          />
          <span className="text-sm text-red-500">Voice typing not supported</span>
        </div>
      );
    }
