  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">স্বাগতম, ড. সাহেব! 👋</h1>
          ...
          <Card key={index} className="transition-all duration-300 hover:shadow-lg hover:scale-105">
            ...
            <CardContent>
              ...
              <div className="flex items-center mt-1">
                ...
                <span className="text-xs text-gray-500 dark:text-gray-400 ml-2">গত মাস থেকে</span>
              </div>
            </CardContent>
          </Card>
        ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-xl font-semibold">সাম্প্রতিক রোগীসমূহ</CardTitle>
          ...
          <CardContent>
            <div className="space-y-4">
              {recentPatients.map((patient, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-800 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700"
                >
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-xl font-semibold">আজকের অ্যাপয়েন্টমেন্ট</CardTitle>
          ...
          <CardContent>
            <div className="space-y-4">
              {upcomingAppointments.map((appointment, index) => (
                <div
                  key={index}
                  className="flex items-center space-x-4 p-3 rounded-lg bg-gray-50 dark:bg-gray-800 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700"
                >
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-xl font-semibold">দ্রুত অ্যাকশন</CardTitle>
