      ...
      <body>
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-4 text-center">
          ...
          <div className="space-x-4">
            ...
            <Link
              href="/"
              className="px-6 py-3 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-semibold rounded-md shadow-md hover:bg-gray-200 dark:hover:bg-gray-800 transition duration-300"
            >
              Go to Homepage
            </Link>
          </div>
